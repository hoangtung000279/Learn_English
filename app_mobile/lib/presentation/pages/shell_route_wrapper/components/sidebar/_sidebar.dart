...
class SideBarWidget extends StatelessWidget {
  ...
  void _handleNavigation(
    ...
    final _currentPath = GoRouter.of(context).routerDelegate.currentConfiguration.fullPath;
        ...
        child: Row(
          ...
          children: [
            ...
            SvgPicture.asset(
              menuTile.iconPath,
              colorFilter: ColorFilter.mode(
                isSelected ? _selectedPrimaryColor : _theme.textTheme.bodyLarge!.color!,
                BlendMode.srcIn,
              ),
            ),
    ...
    if (UserProvider.instance.permissions!.any((e) => e.code == submenu.code)) {
      return Material(
        ...
        child: ListTile(
          ...
          tileColor: _isSelectedSubmenu ? _selectedPrimaryColor.withOpacity(0.20) : null,
          title: Text(submenu.name),
          leading: Icon(
            _isSelectedSubmenu ? Icons.radio_button_checked_outlined : Icons.circle_outlined,
